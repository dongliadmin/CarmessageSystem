...
<body>
	<form action="<%=path%>/modulescontrol/updateModules.spring" method="post"
		...
		<table class="table table-bordered table-hover definewidth m10">
			<tr>
				...
				<td><input type="text" name="description"
					value="${module.description }" /></td>
			</tr>
			<tr>
				<td class="tableleft">用户ID</td>
				<td><input name="module_id" value="${module.module_id }" readonly="true" /></td>
...
<script>
	$(function() {
		$('#backid').click(function() {
			window.location.href = "<%=basePath%>/modulescontrol/showallModules.spring";
		});
	});
</script>